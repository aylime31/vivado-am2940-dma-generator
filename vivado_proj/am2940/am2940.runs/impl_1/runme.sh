...
HD_PWD='D:/AMD/vivado-am2940-dma-generator/vivado_proj/am2940/am2940.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log am2940_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source am2940_top.tcl -notrace
