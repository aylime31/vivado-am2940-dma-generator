...
HD_PWD='D:/AMD/vivado-am2940-dma-generator/vivado_proj/am2940/am2940.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log am2940_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source am2940_top.tcl
