...
REM
REM Generated by Vivado on Fri Jul 11 15:46:26 +0300 2025
...
echo "xvlog --incr --relax -prj word_path_tb_vlog.prj"
call xvlog  --incr --relax -prj word_path_tb_vlog.prj -log xvlog.log
