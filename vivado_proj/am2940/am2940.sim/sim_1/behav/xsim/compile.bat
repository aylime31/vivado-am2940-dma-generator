...
REM
REM Generated by Vivado on Fri Jul 11 17:41:45 +0300 2025
...
echo "xvlog --incr --relax -prj done_gen_tb_vlog.prj"
call xvlog  --incr --relax -prj done_gen_tb_vlog.prj -log xvlog.log
