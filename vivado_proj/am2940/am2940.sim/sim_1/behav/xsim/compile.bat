...
REM
REM Generated by Vivado on Fri Jul 11 14:11:39 +0300 2025
...
echo "xvlog --incr --relax -prj address_path_tb_vlog.prj"
call xvlog  --incr --relax -prj address_path_tb_vlog.prj -log xvlog.log
