...
REM
REM Generated by Vivado on Mon Jul 14 12:20:26 +0300 2025
...
echo "xvlog --incr --relax -prj am2940_tb_vlog.prj"
call xvlog  --incr --relax -prj am2940_tb_vlog.prj -log xvlog.log
